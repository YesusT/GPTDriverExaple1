...
const Ftm_Gpt_Ip_InstanceConfigType FTM_0_InitConfig_PB = 
{
    /** @brief Freeze bit */
    (boolean)(FALSE), /**< @brief Freeze Disable */
    /** @brief FTM clock source  */
    FTM_GPT_IP_CLOCK_SOURCE_SYSTEMCLK,
#if (FTM_GPT_IP_SET_CLOCK_MODE == STD_ON)
    /** @brief GptFtmAlternatePrescaler Value */
    0U, /*Value PS bit:0 */
#endif
    /** @brief GptFtmPrescaler Value */
    7U, /*Value PS bit:7 */
    /** @brief GptFtmCountingMode */
    FTM_GPT_IP_MODE_UP_TIMER
};

const Ftm_Gpt_Ip_ChannelConfigType FTM_0_ChannelConfig_PB[1U] = 
{
    /** @brief GptFtmChannels_0 */
    {
