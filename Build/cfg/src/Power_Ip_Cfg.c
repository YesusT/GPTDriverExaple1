...
#define POWER_IP_CFG_SW_MAJOR_VERSION_C                  2
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Power_Ip_Cfg.c file and Power_Ip_Cfg.h file are of the same vendor */
#if (POWER_IP_CFG_VENDOR_ID_C != POWER_IP_CFG_VENDOR_ID)
    #error "Power_Ip_Cfg.c and Power_Ip_Cfg.h have different vendor ids"
#endif

/* Check if Power_Ip_Cfg.c file and Power_Ip_Cfg.h file are of the same Autosar version */
...
/* Check if Power_Ip_Cfg.c file and Power_Ip_Cfg.h file are of the same Software version */
...
/* Check if Power_Ip_Cfg.c file and Power_Ip_Types.h file are of the same vendor */
#if (POWER_IP_CFG_VENDOR_ID_C != POWER_IP_TYPES_VENDOR_ID)
    #error "Power_Ip_Cfg.c and Power_Ip_Types.h have different vendor ids"
#endif

/* Check if Power_Ip_Cfg.c file and Power_Ip_Types.h file are of the same Autosar version */
...
/* Check if Power_Ip_Cfg.c file and Power_Ip_Types.h file are of the same Software version */
...
/* Check if Power_Ip_Cfg.c file and StandardTypes.h file are of the same Autosar version */
